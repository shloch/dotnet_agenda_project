...
namespace AGENDA.Controllers
{
    public class AgendasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,DateHeure,Concernee,Duree,Lieu,Type")] Agenda agenda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description,DateHeure,Concernee,Duree,Lieu,Type")] Agenda agenda)
        {
            if (id != agenda.Id)
            {
                return NotFound();
